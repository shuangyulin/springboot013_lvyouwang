...
import center from '@/views/center'
    import discusszuixinxianlu from '@/views/modules/discusszuixinxianlu/list'
    import news from '@/views/modules/news/list'
    import zuixinxianlu from '@/views/modules/zuixinxianlu/list'
...
const routes = [{
    ...
    children: [{
      ...
      meta: {icon:'', title:'center'}
          ...
          ,{
	path: '/discusszuixinxianlu',
        name: '最新线路评论',
        component: discusszuixinxianlu
      }
          ,{
	path: '/news',
        name: '旅游资讯',
